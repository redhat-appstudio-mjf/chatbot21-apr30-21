...
2) Go to the `Data Science Projects` section and access your application's project named `chatbot21-apr30-21`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot21-apr30-21-notebook`.
...
5) In the terminal, run `cd chatbot21-apr30-21` to navigate to your sample app's directory.
